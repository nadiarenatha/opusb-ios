...
import 'konfirmasi_fcl.dart';
import 'package:intl/intl.dart';

class SummaryFCL extends StatefulWidget {
  ...
  String get formattedEstimasiNilaiProduk {
    final NumberFormat currencyFormat = NumberFormat.currency(
      locale: 'ID',
      symbol: 'Rp ',
      decimalDigits: 0,
  ...
  @override
  State<SummaryFCL> createState() => _SummaryFCLState();
}

class _SummaryFCLState extends State<SummaryFCL> {
  int _selectedIndex = 0;
  bool isSelected = false;
  bool _isSwitched = false;
  DataLoginAccesses? dataLogin;
  CekHargaFCLAccesses? cekHarga;
  ...
  void initState() {
    ...
    BlocProvider.of<ContractNiagaCubit>(context)
        .cekHargaFCL(widget.kontrak, widget.harga, widget.jumlahContainer);
    _fetchAndLoginUser();
    // BlocProvider.of<CreateOrderCubit>(context).createOrderFCL();
  }
    ...
    return Scaffold(
      ...
      body: BlocConsumer<DataLoginCubit, DataLoginState>(
        ...
        return BlocConsumer<ContractNiagaCubit, ContractNiagaState>(
            listener: (context, state) async {
          if (state is CekHargaFCLNiagaSuccess) {
            setState(() {
              cekHarga = state.response;
            });
            print('Ini Respon Harga nya : $cekHarga');
            print('Ini Total Berat : ${widget.totalBerat}');
            print(
                'Ini Estimasi Nilai Produknya : ${widget.estimasiNilaiProduk}');
            print('Ini Estimasi Closing : ${widget.estimasiClosing}');
          }
        }, builder: (context, state) {
          // return BlocConsumer<CreateOrderCubit, CreateOrderState>(
          //     listener: (context, state) {
          //   if (state is CreateOrderFCLSuccess) {
          //     // final orderNumber = state.responses['orderNumber'];
          //     final orderNumber = state.response.orderNumber;
          //     Navigator.pushReplacement(context,
          //         MaterialPageRoute(builder: (context) {
          //       // return KonfirmasiFCL();
          //       return KonfirmasiFCL(orderNumber: orderNumber);
          //     }));
          //   }
          // }, builder: (context, state) {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Text(
                            //   widget.kontrakData
                            //       .map((contract) => contract.harga.toString())
                            //       .join(", "),
                            //   style: TextStyle(
                            //       color: Colors.red[900],
                            //       fontSize: 14,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(
                              widget.jumlahContainer.toString(),
                              style: TextStyle(
                                  color: Colors.red[900],
                                  fontSize: 14,
                                  fontFamily: 'Poppins Bold'),
                            ...
                            SizedBox(height: 5),
                            Text(
                              widget.formattedEstimasiNilaiProduk,
                              style: TextStyle(
                                  color: Colors.grey[600],
                                  fontSize: 14,
                                  fontFamily: 'Poppins Med'),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(
                              'Alamat Muat ${widget.namaAlamatMuat}',
                              style: TextStyle(
                                  color: Colors.grey[600],
                                  fontSize: 14,
                                  fontFamily: 'Poppins Med'),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        // 'Rp 7,700,000',
                        // cekHarga?.estimasiHarga != null ? cekHarga!.estimasiHarga.toString() : 'N/A',
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () {
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context) {
                            return KonfirmasiFCL(
                                ukuranContainer: widget.ukuranContainer,
                                kontrak: widget.kontrak,
                                jumlahContainer: widget.jumlahContainer,
                                ...
                                harga: cekHarga?.estimasiHarga ?? 0,
                                ...
                                poin: (cekHarga?.point == 'yes')
                                    ? _isSwitched
                                    : false,
                                hargaContract: widget.harga,
                                estimasiNilaiProduk: widget.estimasiNilaiProduk,
                                estimasiClosing: widget.estimasiClosing);
                          }));

...
part 'detail_invoice_lcl.g.dart';

@JsonSerializable()
class DetailInvoiceLCLAccesses extends Equatable {
  ...
  final dynamic hargaKontrak;

  @JsonKey(name: 'biaya_karantina')
  final dynamic biayaKarantina;

  @JsonKey(name: 'biaya_dokumen')
  final dynamic biayaDokumen;

  @JsonKey(name: 'biaya_asuransi')
  final dynamic biayaAsuransi;

  final String? email, rute, volume;

  final dynamic ppn;

  const DetailInvoiceLCLAccesses({
    this.customerId = '',
    this.tanggalInvoice = '',
    this.customerBiling = '',
    this.invoiceNumber = '',
  ...
  factory DetailInvoiceLCLAccesses.fromJson(Map<String, dynamic> json) =>
      _$DetailInvoiceLCLAccessesFromJson(json);
  Map<String, dynamic> toJson() => _$DetailInvoiceLCLAccessesToJson(this);

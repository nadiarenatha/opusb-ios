...
import 'daftar_pembayaran.dart';

class ProfileNiagaPage extends StatefulWidget {
  const ProfileNiagaPage({Key? key}) : super(key: key);

  @override
  State<ProfileNiagaPage> createState() => _ProfileNiagaPageState();
}

class _ProfileNiagaPageState extends State<ProfileNiagaPage> {
  @override

  //Set index to 4 because Profil is the 5th item
          ...
          bottomNavigationBar: Container(
            ...
            child: BottomNavigationBar(
              ...
              items: <BottomNavigationBarItem>[
                ...
                //         Icons.home,
                //         color: Colors
                //             .white, // Icon color (optional for visibility)
                //       ),
                //     ],
                //   ),
                //   label: 'Home',

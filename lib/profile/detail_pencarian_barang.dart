...
class DetailPencarianBarangNiagaPage extends StatefulWidget {
  final DetailDataBarangAccesses stok;
  final String? asnNo;
  const DetailPencarianBarangNiagaPage({
    Key? key,
    required this.stok,
    this.asnNo,
  }) : super(key: key);
  ...
  @override
  State<DetailPencarianBarangNiagaPage> createState() =>
      _DetailPencarianBarangNiagaPageState();
}

class _DetailPencarianBarangNiagaPageState
    extends State<DetailPencarianBarangNiagaPage> {
  @override
  ...
  Future<bool> _onWillPop() async {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => PencarianBarangNiagaPage()),
    );

...
import 'package:niaga_apps_mobile/services/payment_service_impl.dart';
import 'package:dio/dio.dart';
import 'package:flutter_secure_storage/flutter_secure_storage.dart';

class PembayaranVirtual extends StatefulWidget {
  const PembayaranVirtual({super.key});

  @override
  State<PembayaranVirtual> createState() => _PembayaranVirtualState();
}

class _PembayaranVirtualState extends State<PembayaranVirtual> {
  ...
  //       serverKey:
  //           'SB-Mid-server-zbiWPVrVAVdsDSmCh8fMBxpu', // Replace with your actual server key
  //       requestBody: {
  //         "transaction_details": {
  //           "order_id": "ORDER-103",
  //           "gross_amount": 10000

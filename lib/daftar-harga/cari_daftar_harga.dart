...
class CariDaftarHargaPage extends StatefulWidget {
  const CariDaftarHargaPage({Key? key}) : super(key: key);

  @override
  State<CariDaftarHargaPage> createState() => _CariDaftarHargaPageState();
}

class _CariDaftarHargaPageState extends State<CariDaftarHargaPage> {
  @override
